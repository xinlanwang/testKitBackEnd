...
drop table if exists hw_version;
...
drop table if exists sched_name;
...
drop table if exists IDX_RJD1;
drop table if exists IDX_RJD2;
...
drop table if exists IDX_RSD1;
drop table if exists IDX_RSD2;
...
drop table if exists t_carline;
drop table if exists t_carline_component;
drop table if exists t_carline_info;
drop table if exists t_category_menu;
drop table if exists t_clean_mapping;
drop table if exists t_cluster;
drop table if exists t_component_data;
drop table if exists t_data_log;
drop table if exists t_desktop_device;
drop table if exists t_desktop_log;
drop table if exists t_desktop_record;
...
create table t_carline_component
(
    uid                bigint(32) auto_increment comment '主键'
        primary key,
    carline_info_uid   bigint(32)                              not null comment '车型参数主键',
    sw_version_uid     bigint(32)                              null comment '软件版本',
    hw_version_uid     bigint(32)                              null comment '硬件版本',
    minimal_hw         varchar(100)                            null comment '最低配置',
    other_version_uid  bigint(32)                              null,
    temporary_variable varchar(100)                            null comment 'golden表不确定项sop_carline',
    create_time        timestamp null comment '创建时间',
    update_time        timestamp null comment '更新时间',
    create_by_uid      varchar(64)                             null comment '创建者',
    update_by_uid      varchar(64)                             null comment '更新者'
...
(
    ...
    basic_type                varchar(30)                             not null comment '类型',
    create_time               timestamp null comment '创建时间',
    update_time               timestamp null comment '更新时间',
    create_by_uid             varchar(64)                             null comment '创建者',
    update_by_uid             varchar(64)                             null comment '更新者',
    version_code              varchar(50)                             null,
    original_carline_info_uid bigint(32)                              null
)
...
create table t_component_data
(
    uid                     bigint(32) auto_increment comment '序列号，唯一标志主键'
        primary key,
    part_number             varchar(100)                             null comment '自增唯一值',
    ecu_id                  varchar(30)                              null,
    is_avaliabel            tinyint(1) default 1                     null comment '是否可用',
    ware_type               varchar(10)                              null comment 'hw代表硬件，sw软件，ot代表其他',
    component_version       varchar(30)                              null comment '配件版本号',
    component_type          varchar(50)                              null comment 'mu代表mu，gw代表gw，hud代表hud，km代表kombi等',
    component_name          varchar(30)                              null comment '配件名称',
    sort                    int        default 0                     null comment '排序字段',
    create_time             timestamp  null comment '创建时间',
    update_time             timestamp  null comment '更新时间',
    create_by_uid           varchar(64)                              null comment '创建者',
    update_by_uid           varchar(64)                              null comment '更新者',
    component_instance_name varchar(50)                              null
)
...
(
    uid                    bigint(32) auto_increment comment 'auto_increment'
        primary key,
    localhost_user_id      bigint(32)                              null comment '登录人员id',
    oper_user_name         varchar(50)                             null comment '操作人员id',
    data_index             int                                     null,
    operation_uid          varchar(50)                             null comment '操作数据id',
    operation_type         varchar(10)                             null comment '方法名称(1为创建，2为修改，3为删除）',
    operation_filed        varchar(70)                             null comment '修改属性',
    before_operation_value varchar(70)                             null comment '修改前数值',
    after_operation_value  varchar(70)                             null comment '修改后数值',
    request_method         varchar(10)                             null comment '请求方式',
    oper_time              timestamp null comment '操作时间',
    oper_url               varchar(255)                            null comment '请求URL',
    oper_ip                varchar(128)                            null comment '主机地址'
)
    comment '`BIGINT(32) auto_increment`' charset = utf8;

create table t_desktop_device
(
    uid                        bigint(32) auto_increment comment 'auto_increment'
        primary key,
    carline_info_uid           bigint(32)                              not null comment '车型参数主键',
    ...
    create_by_uid              varchar(64)                             null comment '创建者',
    update_by_uid              varchar(64)                             null comment '更新者',
    desktop_device_information varchar(128)                            null comment '操作设备信息'
)
    comment '`BIGINT(32) auto_increment`' charset = utf8;

create table t_desktop_log
(
    uid                    bigint(32) auto_increment comment 'auto_increment'
        primary key,
    localhost_user_id      bigint(32)                              null comment '登录人员id',
    ...
    operation_uid          varchar(50)                             null comment '操作数据id',
    operation_type         varchar(10)                             null comment '方法名称(1为创建，2为修改，3为删除）',
    operation_filed        varchar(100)                            null comment '修改属性',
    before_operation_value varchar(50)                             null comment '修改前数值',
    after_operation_value  varchar(50)                             null comment '修改后数值',
    request_method         varchar(10)                             null comment '请求方式',
    oper_time              timestamp null comment '操作时间',
    oper_url               varchar(255)                            null comment '请求URL',
    oper_ip                varchar(128)                            null comment '主机地址',
...
create table t_desktop_record
(
    uid                   bigint(32) auto_increment comment 'auto_increment'
        primary key,
    localhost_user_id     varchar(50)                             null comment '登录人员id',
    oper_user_name        varchar(50)                             null comment '操作人员id',
    data_uid              varchar(50)                             null comment '操作数据id',
    oper_time             timestamp null comment '操作时间',
    ...
    black_map             varchar(50)                             null comment 'blackMap',
...
(
    ...
    login_time     timestamp null comment '访问时间'
)
...
(
  ...
  update_time      datetime                                   comment '更新时间',
  remark           varchar(500)    default null               comment '备注',
  matrix_type           varchar(50)    default null               comment 'lx',
