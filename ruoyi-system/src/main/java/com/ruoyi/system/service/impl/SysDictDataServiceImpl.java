...
public class SysDictDataServiceImpl implements ISysDictDataService
{
    ...
    public void deleteDictDataByIds(Long[] dictCodes)
    {
        for (Long dictCode : dictCodes)
        {
            ...
            dictDataMapper.logicDelectDictDataById(dictCode);
     ...
     * @param dictCodes 需要删除的字典数据ID
     */
    public void logicDeleteDictDataByIds(Long[] dictCodes)
    {
        dictDataMapper.logicDelectDictDataByIds(dictCodes);
    }
    ...
    public List<SysDictData> selectMatrixDictDataList(SysDictData dictData) {
        return dictDataMapper.selectMatrixDictDataList(dictData);
    }
