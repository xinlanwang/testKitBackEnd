...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
     ...
     */
    @Override
    public Map<String,List<SysDictData>> selectValidateList()
    {
        Map<String,List<SysDictData>> sysDictDatas = new HashMap<>();
