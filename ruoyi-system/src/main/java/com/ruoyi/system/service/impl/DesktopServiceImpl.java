...
public class DesktopServiceImpl implements DesktopService {
    ...
    public String submit(DesktopSubmitParam desktopSubmitParam) {
        ...
        List<TDesktopRecord> tDesktopRecords = new ArrayList<TDesktopRecord>();
        for (DesktopRecordParam desktopRecordParam:desktopRecordParams){
                ...
                tDesktopRecord.setDataUid(desktopRecordParam.getDesktopDeviceUid());
                tDesktopRecords.add(tDesktopRecord);
        }
